...
export function validateRepositoryContent(root = defaultRoot) {
  ...
  if (forkDesktop) {
    expect(desktop?.version === '0.1.5-rc.3.cloga.5', 'Desktop fork version differs')
    expect(desktop?.source?.releaseTag === 'dsh-desktop-v0.1.5-rc.3.cloga.5', 'Desktop fork release tag differs')
    expect(desktop?.source?.commit === '29f1863f5457470bacd12de00e987b8bdd6f4b2f', 'Desktop fork source commit differs')
    expect(desktop?.source?.reviewedHead === '6a6330f011ae48b9f2193026bc64c77765bdb4ec', 'Desktop fork reviewed head differs')
    expect(desktop?.artifact?.sha256 === 'f39c5dba008385614428e89c3e28f85f0d3aeb24cc0f7992ac1c63c3082c717c', 'Desktop fork installer digest differs')
    expect(desktop?.artifact?.size === 180176641, 'Desktop fork installer size differs')
    ...
    expect(desktop?.installedExecutable?.sha256 === '2ee392923d3796c9d68fbcfec675be558a3b0d68c3a68ec5dbce0f88a8212561', 'installed Desktop fork executable digest differs')
    ...
    expect(desktop?.installedRuntimeDescriptor?.sha256 === 'f21d8b8fb67ed04554290acf3a48c91ea163bef7772842fd0796e0e97788d72d', 'installed Desktop runtime descriptor digest differs')
    ...
    expect(desktop?.releaseChannel?.manifestRawSha256 === 'b6fa1c79fd4a534c1ed7b5bc9caa85241e6c91d0745f07c800dad112176f161e', 'Desktop fork manifest raw digest differs')
    expect(desktop?.releaseChannel?.manifestSha256 === '2e5b8efbabd812b07258e0fa794ffa04a7084f84a86ac6ee3ca534c034221152', 'Desktop fork manifest self digest differs')
    try {
