...
|---|---|---|---|
| Host-wide isolated Edge testing through `dsh-playwright-host@0.1.2` | [`cloga/dsh-playwright-host@v0.1.2`](https://github.com/cloga/dsh-playwright-host/commit/2cf6edfd52b5a70b3f6af7b1f502c58718a6f5ac) | **Optional active overlay** | Cataloged and functionally verified, but not required by the Windows Copilot lock; one Host MCP process is shared across Sessions. |
| Session-bound scheduling through `dsh-cron@0.4.1` | [`cloga/dsh-cron@v0.4.1`](https://github.com/cloga/dsh-cron/releases/tag/v0.4.1) | **Optional active overlay** | Cataloged Web-only scheduler; Windows native notification flags are documented quiet no-ops. |
