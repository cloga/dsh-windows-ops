...
| `dsh-github-copilot` | 0.3.0-cloga.2 |
...
| [`cloga/dsh-github-copilot`](https://github.com/cloga/dsh-github-copilot) | One DSH plugin using built-in `@deepseek-ai/dsh-llm-pi-ai` for OAuth, account models, token refresh, direct Copilot transport, and hosted search; no ACP | Deployment pin `8af7edb7` / `0.3.0-cloga.2` |
