...
The lock now selects the formally published `.6` ASAR target; source-owned
release acceptance passed, but genuine Ops observer/manual qualification is
still pending. Publication and repinning do not install or activate it.
