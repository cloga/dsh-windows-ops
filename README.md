...
| [`cloga/dsh-github-copilot`](https://github.com/cloga/dsh-github-copilot) | 一个 DSH 插件，复用内置 `@deepseek-ai/dsh-llm-pi-ai` 的 OAuth、账户模型、刷新、Copilot 直连和 hosted search；不包含 ACP | 部署精确 pin `8af7edb7` / `0.3.0-cloga.2` |
