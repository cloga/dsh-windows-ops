...
| Desktop | fork-owned `0.1.6-alpha.1.cloga.14`, sequence 24, source `a0f0144f4cddc90c45f8be93c61c0cd6cec470c7`; formal source acceptance passed, genuine registered native Ops qualification pending (no local activation) |
