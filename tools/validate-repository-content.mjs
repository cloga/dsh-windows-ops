...
export function validateRepositoryContent(root = defaultRoot) {
  ...
  if (forkDesktop) {
    expect(desktop?.version === '0.1.5-rc.3.cloga.4', 'Desktop fork version differs')
    expect(desktop?.source?.releaseTag === 'dsh-desktop-v0.1.5-rc.3.cloga.4', 'Desktop fork release tag differs')
    expect(desktop?.source?.commit === '45fd3a15b6a259ef84ef23d6fc9aa89406b50a69', 'Desktop fork source commit differs')
    expect(desktop?.source?.reviewedHead === '84d5f2166b6372d0b28bf7aaf96e766109cc0bf9', 'Desktop fork reviewed head differs')
    expect(desktop?.artifact?.sha256 === '5e76219fb33b011bf17cca55acd1e38d5685d7632f4ca111c3209bd36748cc91', 'Desktop fork installer digest differs')
    expect(desktop?.artifact?.size === 180175906, 'Desktop fork installer size differs')
    ...
    expect(desktop?.installedExecutable?.sha256 === '9d5f4e0365e994efa754182cf8da831f635644ff120f0c84356873d3a97ba3bf', 'installed Desktop fork executable digest differs')
    ...
    expect(desktop?.installedRuntimeDescriptor?.sha256 === 'bc8782b7c265b9d50ffd9d60af139603fd2c011605233b8d6cfea1f302971fb2', 'installed Desktop runtime descriptor digest differs')
    ...
    expect(desktop?.releaseChannel?.manifestRawSha256 === 'c672e7b1fb1f005012fbca0ca5db1418767c0773da424704a30ceff92a4fe70c', 'Desktop fork manifest raw digest differs')
    expect(desktop?.releaseChannel?.manifestSha256 === 'c6335ff8e8e176bd9ced039533d6d66208cc73c73d3148d5c960c46bb5522c0b', 'Desktop fork manifest self digest differs')
    try {
