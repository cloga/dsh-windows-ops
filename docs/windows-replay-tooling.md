...
| Desktop | fork-owned `0.1.6-alpha.1.cloga.16`, sequence 27, source `2c4f20904887240f83f776c79d8d69a42ce6c1e6`; formal run `35569892548` attempt 2 passed; hosted Native Ops run `35575187267` attempt 1 passed at exact Ops code head `a59f586df4e329c3bc8b3f885013fdb5493f4970` (no local activation) |
